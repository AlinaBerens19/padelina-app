// Module-level Gradle file for Android app (Kotlin DSL)
...
android {
    namespace = "com.alinaberens.padelina"
    compileSdk = rootProject.extra["compileSdkVersion"] as Int

    defaultConfig {
        applicationId = "com.alinaberens.padelina"
...
dependencies {
    ...
    // Firebase SDKs (no explicit versions)
    ...
    // Hermes or JSC fallback
    val hermesEnabled: Boolean = (project.findProperty("hermesEnabled") as String?)?.toBoolean() ?: false
    if (hermesEnabled) {
...
//     // Убраны явные версии, так как используется Firebase BoM
//     implementation("com.google.firebase:firebase-analytics")
//     implementation("com.google.firebase:firebase-auth")
//     implementation("com.google.firebase:firebase-messaging")
//     implementation("com.google.firebase:firebase-crashlytics")
